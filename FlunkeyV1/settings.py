"""
Django settings for FlunkeyV1 project.
...
SECRET_KEY = 'sx7d+5&c-+jbne)-k04@22qy413qsp8v00*tnm__d((7t8wayt'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'AccountsApp.context_processors.rest_data',
...
WSGI_APPLICATION = 'FlunkeyV1.wsgi.application'
